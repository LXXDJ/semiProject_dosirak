...
(1,'아이디, 비밀번호를 잊어버렸습니다','아이디, 비밀번호 찾기 안내\r\n\r\n하기 경로를 통해 아이디 및 비밀번호 찾기가 가능하며,\n 임시 비밀번호의 경우 회원가입 시 등록한 이메일 주소로 발송 됩니다.\r\n\r\n(PC) 홈페이지 상단 [로그인] > 화면 아래 [아이디 찾기], [비밀번호 찾기]\r\n\r\n[참고]\r\n가입 시 기재한 메일 주소가 기억나지 않으시거나 오류가 발생하는 경우 고객센터로 문의 바랍니다.\r\n상담 시에는 고객님의 개인정보보호를 위해 기존에 사용하시던 비밀번호는 안내가 불가하며,\n 개인정보 확인 후 임시 비밀번호를 설정해드립니다.','choijihyun7',1),
